...
$query = "SELECT post.post_id, post.title, post.description,post.post_image, post.post_date,post.category, category.category_name,users.username FROM post
  LEFT JOIN category ON post.category = category.category_id
  LEFT JOIN users ON post.author = users.user_id WHERE post.category={$rcv_cid}
